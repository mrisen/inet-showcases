...
<p><pre class="snippet" src="../../general/ethernet/largeNet/largeNet.ini" from="# MAC settings" until="# queue" comment="#!"></pre></p>
...
<p><pre class="snippet" src="../../general/ethernet/largeNet/largeNet.ini" from="# queue" until="#####" comment="#!"></pre></p>
...
<p><pre class="snippet" src="../../general/ethernet/largeNet/largeNet.ini" from="scalar- and vector-recording disabled" until="number of hosts" comment="#!"></pre></p>
...
<p><pre class="snippet" src="../../general/ethernet/largeNet/largeNet.ini" from="# statistics" until="#####" comment="#!"></pre></p>
...
<p><pre class="snippet" src="../../general/ethernet/largeNet/largeNet.ini" from="sendInterval -> average 25 requests per sec" until="#####" comment="#!"></pre></p>
...
<p><pre class="snippet" src="../../general/ethernet/largeNet/largeNet.ini" from="LargeNet.n = 15" until="#####" comment="#!"></pre></p>
